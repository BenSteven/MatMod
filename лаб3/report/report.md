...
subtitle: "Модель боевых действий - вариант 70"
...
a = 0.21;//константа, характеризующая степень влияния различных факторов на потери армии х
b = 0.855;//эффективность боевых действий армии у
c = 0.455;//эффективность боевых действий армии х
h = 0.32;//константа, характеризующая степень влияния различных факторов на потери армии у
...
y0 = 60000;//численность второй армии
t0 = 0;//начальный момент времени
a = 0.267;//константа, характеризующая степень влияния различных факторов на потери армии х
b = 0.687;//эффективность боевых действий армии у
c = 0.349;//эффективность боевых действий армии х
h = 0.491;//константа, характеризующая степень влияния различных факторов на потери армии у
tmax = 1;//предельный момент времени
dt = 0.05;//шаг изменения времени
t = [t0:dt:tmax];
function p=P(t)//возможность подхода подкрепления к армии х
